...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loadProjects = __webpack_require__(2);
	...
	var _gradientHeight = __webpack_require__(6);
	
	var _gradientHeight2 = _interopRequireDefault(_gradientHeight);
	
	(0, _loadProjects2['default'])();
	
	(0, _jquery2['default'])(window).resize(function () {
	  (0, _gradientHeight2['default'])();
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _magnificPopup = __webpack_require__(7);
	...
	exports['default'] = function () {
	  ...
	  (0, _jquery2['default'])('.info').each(function (i) {
	    ...
	    for (var _i = 0; _i <= numberOfImages; _i++) {
	      imgArray.push('<img src=\'img/' + projectLink + '/slide-' + _i + '.jpg\' alt=\'\' />');
	    }
	
	    var productTemplate = function productTemplate() {
	  ...
	  (0, _jquery2['default'])(content.join('')).appendTo('body');
	
	  if (content) {
	    (0, _jquery2['default'])('.info').magnificPopup({
	      type: 'inline'
	    });
	  } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GRADIENT_SELECTOR = (0, _jquery2['default'])('.hero-gradient');
	var GRADIENT_DIV_SELECTOR = GRADIENT_SELECTOR.find('div');
	var IMAGE_SELECTOR = (0, _jquery2['default'])('.hero-img > img');
	...
	var Slideshow = (function () {
	  ...
	  _createClass(Slideshow, [{
	    key: 'owlSlideshow',
	    value: function owlSlideshow() {
	      var _this = this;
	
	      setTimeout(function () {
	        if (_this.slideIndex < 2) {
	          _this.slideIndex++;
	        } else {
	          _this.slideIndex = 0;
	        }
	        IMAGE_SELECTOR.eq(_this.slideIndex - 1).removeClass(_constants2['default'].activeModifier);
	        IMAGE_SELECTOR.eq(_this.slideIndex).addClass(_constants2['default'].activeModifier);
	        GRADIENT_DIV_SELECTOR.eq(_this.slideIndex - 1).removeClass(_constants2['default'].activeModifier);
	        GRADIENT_DIV_SELECTOR.eq(_this.slideIndex).addClass(_constants2['default'].activeModifier);
	        _this.owlSlideshow();
	      }, 3000);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function gradientHeight() {
	  (0, _jquery2['default'])('.hero-gradient').css('height', (0, _jquery2['default'])('.hero').outerHeight());
	}
